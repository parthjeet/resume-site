...
Portfolio content is organized in `src/data/content.ts`:
...
3. Add route case in `src/pages/Index.tsx` renderScreen function
...
- [UI-PATTERNS.md](./docs/UI-PATTERNS.md) - shadcn/ui usage and patterns
- [STATE-MANAGEMENT.md](./docs/STATE-MANAGEMENT.md) - State management and navigation
- [DATA-MODELS.md](./docs/DATA-MODELS.md) - Data structures and types
- [DEVELOPMENT.md](./docs/DEVELOPMENT.md) - Development guide for contributors

---

**For Contributors**: This project welcomes contributions. See [DEVELOPMENT.md](./docs/DEVELOPMENT.md) for setup instructions and coding guidelines.
